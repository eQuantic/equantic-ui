...
/// modified one, which differ when a hunk before them added or removed lines. <see cref="Header"/> is
/// the header of the hunk after them, which is what a view of the patch says in their place.
/// </summary>
