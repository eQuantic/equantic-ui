...
public class SimpleIconsIconProvider : IIconProvider
{
    ...
    private MethodInfo? GetMethod(string name)
    {
        ...
        return typeof(SimpleIcons).GetMethod(pascalName, new[] { typeof(int), typeof(double), typeof(string), typeof(string) });
    }
}
