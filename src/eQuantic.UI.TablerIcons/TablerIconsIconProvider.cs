...
public class TablerIconsIconProvider : IIconProvider
{
    ...
    private MethodInfo? GetMethod(string name)
    {
        ...
        return typeof(TablerIconsIcons).GetMethod(pascalName, new[] { typeof(int), typeof(double), typeof(string), typeof(string) });
    }
}
