...
public class FontAwesome6RegularIconProvider : IIconProvider
{
    ...
    private MethodInfo? GetMethod(string name)
    {
        ...
        return typeof(FontAwesome6RegularIcons).GetMethod(pascalName, new[] { typeof(int), typeof(double), typeof(string), typeof(string) });
    }
}
