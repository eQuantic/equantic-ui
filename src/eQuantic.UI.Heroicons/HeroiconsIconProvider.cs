...
public class HeroiconsIconProvider : IIconProvider
{
    ...
    private MethodInfo? GetMethod(string name)
    {
        ...
        return typeof(HeroiconsIcons).GetMethod(pascalName, new[] { typeof(int), typeof(double), typeof(string), typeof(string) });
    }
}
