import { $eq, Box, BoxStyle, BuildContext, CodeDecoration, CodeDocument, CodeGutterMarker, CodeHighlighter, CodeLanguages, Color, ColorToken, Column, CornerRadii, EdgeInsets, IconButton, Positioned, Pressable, Row, ScrollView, SizeValue, Sizing, Spacer, Stack, StatelessComponent, Text, TypeStyle, VisualNode } from "../runtime-exports";
...
export class CodeBlock extends StatelessComponent {
    ...
    static gutterColor(kind: string, theme: any) {
