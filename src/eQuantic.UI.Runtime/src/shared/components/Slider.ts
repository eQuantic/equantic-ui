...
export class Slider extends StatelessComponent {
    ...
    build(context: BuildContext) {
        ...
        return this.disabled ? box : new Adjustable(box, (direction: number) => this.onChanged?.(this.quantize(this.value + direction * step, step)), { label: this.label, value: new AdjustableValue(this.value, this.min, this.max, { text: this.valueText }) });
    }
