import { Box, BoxStyle, BuildContext, CornerRadii, Icon, IconsValue, Pressable, Row, SizeValue, SizeVariantValue, Sizing, StatelessComponent, Text } from "@equantic/runtime";
