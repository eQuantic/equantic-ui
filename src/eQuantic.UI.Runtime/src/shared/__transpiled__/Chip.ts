import { Box, BoxStyle, BuildContext, CornerRadii, EdgeInsets, Icon, Pressable, Row, SizeValue, StatelessComponent, Text, TypeStyle } from "@equantic/runtime";
