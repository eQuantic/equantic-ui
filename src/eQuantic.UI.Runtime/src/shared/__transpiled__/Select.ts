import { Anchored, Box, BoxStyle, BuildContext, Column, CornerRadii, EdgeInsets, Flexible, Icon, IconSize, Pressable, Row, SharedStatefulComponent, SizeValue, Space, Spacer, StyleDiff, Text, UiComponent } from "@equantic/runtime";
