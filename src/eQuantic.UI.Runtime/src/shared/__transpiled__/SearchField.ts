import { Box, BoxStyle, BuildContext, CornerRadii, EdgeInsets, Flexible, Icon, Pressable, Row, SdkStrings, SizeValue, Sizing, StatelessComponent, TextEntry } from "@equantic/runtime";
