import { Box, BoxStyle, BuildContext, Column, CornerRadii, EdgeInsets, Flexible, Icon, Pressable, Row, SdkStrings, SizeValue, StatelessComponent, Text, TypeStyle } from "@equantic/runtime";
