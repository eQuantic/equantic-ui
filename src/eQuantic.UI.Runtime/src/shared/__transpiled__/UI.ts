...
export class UI {
    ...
    static appBar(title: string) { return new AppBar(title); }
    static listItem(title: string, subtitle: string | null = null, onPressed: (() => void) | null = null) { return new ListItem(title, subtitle, onPressed); }
    static listView(count: number, itemExtent: number, itemBuilder: (value: number) => VisualNode) { return new ListView(count, itemExtent, itemBuilder); }
