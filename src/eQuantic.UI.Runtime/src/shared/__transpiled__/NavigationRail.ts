import { Badge, Box, BoxStyle, BuildContext, Column, CornerRadii, EdgeInsets, Icon, IconsValue, NavItem, Pressable, SizeValue, StatelessComponent, Text, TypeStyle } from "@equantic/runtime";
