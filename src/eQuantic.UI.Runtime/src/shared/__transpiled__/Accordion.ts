import { Box, BoxStyle, BuildContext, Column, Divider, EdgeInsets, Flexible, Icon, IconSize, Pressable, Row, SharedStatefulComponent, SizeValue, Space, Spacer, StyleDiff, Text, UiComponent } from "@equantic/runtime";
