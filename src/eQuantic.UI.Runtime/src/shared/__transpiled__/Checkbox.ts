import { Box, BoxStyle, BuildContext, CornerRadii, Icon, Pressable, Row, SdkStrings, Sizing, StatelessComponent, Text, VisualNode } from "@equantic/runtime";
