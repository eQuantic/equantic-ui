...
/// <summary>
/// A node that wraps exactly ONE child — twenty-one of the vocabulary's forty, and the shape Flutter
...
/// base is the same statement the compiler keeps true for the twenty-second wrapper.
/// </para>
///
/// <para>
...
/// it, which is the contract twenty-one nodes have and one does not.
/// </para>
/// </summary>
/// <remarks>
