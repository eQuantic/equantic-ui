...
#line 153
    ...
    float _S14 = pixel_2.x;

#line 157
    float _S15 = pixel_2.y;



    float2 uv_1 = (float2(_S14 * u_4->inv0_0.x + _S15 * u_4->inv0_0.y + u_4->inv0_0.z, _S14 * u_4->inv1_0.x + _S15 * u_4->inv1_0.y + u_4->inv1_0.z) - (u_4->rect_0.xy - u_4->rect_0.zw)) / (u_4->rect_0.zw * float2(2.0f) );
    float _S16 = uv_1.x;
...
#line 162
    ...
    int3 _S18 = int3(min(int((&kernelContext_3)->u_0->gradient_0.x) - int(1), int(_S16 * (&kernelContext_3)->u_0->gradient_0.x)), min(int((&kernelContext_3)->u_0->gradient_0.y) - int(1), int(uv_1.y * (&kernelContext_3)->u_0->gradient_0.y)), int(0));

#line 166
    float4 texel_0 = (((&kernelContext_3)->colorTexture_0).read(vec<uint,2>(((_S18)).xy), uint(((_S18)).z)));
...
#line 176
    pixelOutput_2 _S19 = { float4(texel_0.xyz * float3(a_2) , a_2) };
    return _S19;
}
