...
public class PhosphorIconProvider : IIconProvider
{
    ...
    private MethodInfo? GetMethod(string name)
    {
        ...
        return typeof(PhosphorIcons).GetMethod(pascalName, new[] { typeof(int), typeof(double), typeof(string), typeof(string) });
    }
}
