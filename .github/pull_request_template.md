...
- [ ] The documentation changed with the behaviour: this repository's Markdown here, and the wiki page in English AND Portuguese, in one commit of the [wiki repository](https://github.com/eQuantic/equantic-ui/wiki) published when this merges (the twin lives at `locale/pt-BR/<Page>-pt-BR.md` there)
