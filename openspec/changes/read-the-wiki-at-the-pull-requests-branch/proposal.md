...
`AGENTS.md`, `CONTRIBUTING.md`, `.github/pull_request_template.md`, one message in
`tests/eQuantic.UI.Web.Tests/WikiDiagnosticsTests.cs`, and `docs/LEDGER.md`. The wiki repository
