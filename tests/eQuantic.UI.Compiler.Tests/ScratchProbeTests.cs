...
public class ScratchProbeTests
{
    ...
    [Fact]
    public void Probe_CollectionInitializer_WithRefs()
    {
        ...
        File.WriteAllText("/private/tmp/claude-502/-Users-admin-edgar-a-mesquita-projects-equantic-equantic-ui/49769e12-f60f-466c-b793-ec1b263c3197/scratchpad/probe-collection-init-refs.txt",
            "C# errors:\n" + string.Join("\n", csharpErrors)
