...
/// <summary>Spec S7 on Photon: Layer reorders the Stack's PAINT (and hit) order — higher paints
...
public class S7ZOrderTests
{
    ...
    public void Layer_ReordersPaint_HigherOnTop()
    {
        ...
        stack.Add(new Positioned(Marker(0x20), top: 0) { Layer = 1 });
        ...
        reds.Should().Equal(new byte[] { 0x10, 0x20, 0x30 }, "paint order follows Layer ascending (topmost last)");
    }
