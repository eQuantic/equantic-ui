...
| W-B4 | Hit-testing is rectangle-only | `PhotonHost.cs:1507-1535` — every pointer resolution is `Bounds.Contains(point)` on AABBs; `OnPressed` carries no coordinates |
