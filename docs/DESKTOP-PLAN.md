...
| W-B4 | Hit-testing is rectangle-only | `PhotonHost.cs:1456-1484` — every pointer resolution is `Bounds.Contains(point)` on AABBs; `OnPressed` carries no coordinates |
